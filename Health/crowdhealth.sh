...
cat ../healthandnonhealth ../FilteredTweetsWithOptimization > ../FilteredTweetsTobeTested


echo 'Converting Input into LIBSVMFormat' 
javac Classification/TwoClassClasification/Testing/UnigramsBigramsTrigrams.java
java -cp ./Classification/TwoClassClasification/ Testing.UnigramsBigramsTrigrams ../FilteredTweetsTobeTested ../stopwords.txt


echo 'Creating Training File'
head -5070 ../InputFile > ../TrainFile
