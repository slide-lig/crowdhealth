...
public class FilteronFirstFoodList {
    ...
    public static String concat(String[] words, int start, int end) {
	 ...
	 public static void main(String args[])
	  ...
	  BufferedReader br = new BufferedReader(new InputStreamReader(in));
	  String strLine;
	  PrintWriter out  = new PrintWriter(new BufferedWriter(new FileWriter("../FilteredTweetsWithFoodItemsLowerCase",true)));
		  ...
		  int length = tokenizer.length;
			...
			continue;
		  	...
		  	for(int i = 0 ; i < tokens.length ; i ++)
		  	{
		  		...
		  		{
		  			out.write(strLine+"\t"+tokens[i].toLowerCase()+"\n");
		  			break;
		  		}
		  	}	  	
