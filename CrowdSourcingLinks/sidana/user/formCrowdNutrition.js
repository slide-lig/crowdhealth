...
function getNewTweets(dataSetName) {
    var serviceUrl = "http://nutritionunleashedforus.com/sidana/user/getNewTweets.php?dataSetName=" + dataSetName;
    $.ajax({
        url:serviceUrl,
        async:true,
        dataType: "json",
...
function postData(label,uniqueTweetId,tweetId,labelId) {
    var serviceUrl = "http://nutritionunleashedforus.com/sidana/user/saveTweetLabels.php";
    $.ajax({
        url:serviceUrl,
        type: "POST",
        data : {
